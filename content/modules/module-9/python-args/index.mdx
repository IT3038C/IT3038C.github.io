...
1. Accept the Assignment on Canvas.
  * This will create a repository for you with a few starting files.
    ```
      ...
      ├── e5_args.py                ⬅️
      ├── test_e1_list_dir.py
      ├── test_e2_delete_dir.py
      ├── test_e3_rename_dir.py
      ├── test_e4_search_dir.py
      ├── test_e5_args.py
      ├── .gitignore
      ├── requirements.txt
...
- [Standard Python argparse module](https://docs.python.org/3.10/library/argparse.html#module-argparse)
