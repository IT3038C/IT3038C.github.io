...
2. Open the file `arrays_3.py`. Particularly at this function
    ```python
      '''
      ...
      def index_of(arr, item):
          return
    ```
3. The `index_of` method is supposed to return the index of a certain element in an array. [You can learn more about Python Built-in method here](https://docs.python.org/3.10/library/array.html?highlight=inde#array.array.index)
