...
1. Accept the Assignment on Canvas.
  * This will create a repository for you with a few starting files.
    ```
      ...
      ├── test_csv_clean_transform.py
      ├── test_csv_filter.py
      ├── test_csv_read_data.py
      ├── test_csv_write_data.py
      ├── test_pandas_analysis.py
      ├── test_pandas_clean_transform.py
      ├── test_pandas_filter.py
      ├── test_pandas_read_data.py
      ├── test_pandas_write_data.py
      ├── test_regex.py
      ├── .gitignore
      ├── requirements.txt
...
## Resources
- [Standard Python datetime module](https://docs.python.org/3.10/library/datetime.html#module-datetime)
- [Standard Python csv module](https://docs.python.org/3.10/library/csv.html#module-csv)
