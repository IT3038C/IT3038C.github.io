...
## Resources
- [Standard Python OS module](https://docs.python.org/3.10/library/os.html#module-os)
- [Standard Python subprocess module](https://docs.python.org/3.10/library/subprocess.html#module-subprocess)
- [Standard Python shutil module](https://docs.python.org/3.10/library/shutil.html#module-shutil)
